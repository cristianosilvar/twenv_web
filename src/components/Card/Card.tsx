import { Box, HStack, Text, Heading, BoxProps } from "@chakra-ui/layout";

import iconDown from "../../assets/icon-down.svg";
import iconUp from "../../assets/icon-up.svg";

interface CardInterface extends BoxProps {
  is:
    | "newSpending"
    | "newEarning"
    | "totalSpending"
        ...
        {is.includes("new") ? (
          ...
          <>
            <HStack fontSize="lg">
              ...
              <Text fontWeight="medium" opacity=".8">
                R$ {value},00
              </Text>
            </HStack>
            <Heading
