...
interface ModalCreateSpendingProps
...
export const ModalCreateSpending = ({
  children,
  title,
  buttonWidth = 'full',
  buttonHeight = 'full',
  callback,
}: ModalCreateSpendingProps) => {
  return (
    <DialogRoot
      placement="center"
      size="md"
          ...
          <DialogBody py={6}>
            <SimpleGrid columns={12} gap={6}>
              <GridItem colSpan={12}>
                <InputTextarea
                  name="description"
                  placeholder="Qual o nome, descrição e/ou informação desse despesa?"
                  minHeight="124px"
                />
              </GridItem>
              <GridItem colSpan={6}>
